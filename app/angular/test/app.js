...
define(['app'], function (app) {
    ...
    app.register.controller('testCtrl', ['$scope',
        function ($scope) {

        }]);

    app.register.controller('testController', ["localStorageService", '$stateParams', "$resource", "$http", "$scope", "rest",
        function (localStorageService, $stateParams, $resource, $http, $scope) {
            ...
            $scope.submit = function () {
                ...
                $scope.authToken = AuthToken.save({
                        ...
                        primary_address: {
                            ...
                            lat: 42.5890261,
                            lng: -83.70145959999999,
                            state: "MI ",
                            street_line1: "1109 South Pleasant Valley ",
                            street_line2: " ",
                            zipcode: "48380"
                        },
                        referred_by: null,
